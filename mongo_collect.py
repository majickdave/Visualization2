    ...
    for item in results['items']:
        ...
        for artist in track['artists']:
        	...
        	try:
        		...
        		urllib.urlretrieve(image_url, '/Users/majic/NetBeansProjects/OrbPlot/build/classes/data/'+imageurl+'.jpeg')
        	except IOError as e:
        		#print artist['name']
        		#import pdb;pdb.set_trace()
        		pass
        ...
        urllib.urlretrieve(track_image_url, '/Users/majic/NetBeansProjects/OrbPlot/build/classes/data/'+artist_name+'_'+album_name+'_'+track_name+'.jpeg')
        ...
        top_tracks.append({"track_name": track_name, "artist_name" : artist_name, 
        	...
        	"related_artist_popularity": related_popularity, "features": features, "followers": related_followers[artist_name], "genres": related_genres[artist_name]})
